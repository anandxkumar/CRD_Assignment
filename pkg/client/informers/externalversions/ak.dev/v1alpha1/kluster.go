...
import (
	...
	akdevv1alpha1 "github.com/anandxkumar/kluster/pkg/apis/ak.dev/v1alpha1"
	versioned "github.com/anandxkumar/kluster/pkg/client/clientset/versioned"
	internalinterfaces "github.com/anandxkumar/kluster/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/anandxkumar/kluster/pkg/client/listers/ak.dev/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AkV1alpha1().Klusters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AkV1alpha1().Klusters(namespace).Watch(context.TODO(), options)
			},
		},
		&akdevv1alpha1.Kluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *klusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&akdevv1alpha1.Kluster{}, f.defaultInformer)
}
