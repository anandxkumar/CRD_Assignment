...
// 	obj, shutdown := c.workqueue.Get() // Get the obj from workqueue
// 	if shutdown {
...
// 	log.Println("WE GOT KEY: ", key)
// 	ns, name, err := cache.SplitMetaNamespaceKey(key)
// 	if err != nil {
// 		klog.Errorf("error while splitting key into namespace & name: %s", err.Error())
// 		return false
// 	}
// 	log.Println("WE GOT NS: ", ns)
// 	log.Println("WE GOT NAME: ", name)
...
// 	foo, _ := c.foosLister.Klusters(ns).Get(name)
// 	log.Println("Foo: ", foo)
// 	// setting foo.Spec.Count
// 	foo.Spec.Count = 0

// 	print("FOO COUNT: ", foo.Spec.Count)
// 	c.workqueue.Add(key)
